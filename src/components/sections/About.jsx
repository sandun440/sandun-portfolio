      ...
      <RevealOnScroll>
        <div className="max-w-5xl w-full mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            {/* Education Card 1 */}
            <div className="p-6 rounded-xl bg-gradient-to-br from-cyan-900/10 to-cyan-400/5 border border-white/10 shadow-md hover:shadow-cyan-300/30 transition-all transform hover:scale-[1.02]">
              ...
              <p className="text-gray-300">The Open University of Sri Lanka</p>
              <p className="text-sm text-cyan-200 mt-1">2023 – Present</p>
              <div className="mt-4">
            ...
            {/* Education Card 2 */}
            <div className="p-6 rounded-xl bg-gradient-to-br from-blue-900/10 to-blue-400/5 border border-white/10 shadow-md hover:shadow-blue-300/30 transition-all transform hover:scale-[1.02]">
              ...
              <p className="text-sm text-blue-200 mt-1">2023 – 2024</p>
              <div className="mt-4">
