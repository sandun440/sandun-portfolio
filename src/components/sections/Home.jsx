      ...
      {particles.map((particle) => (
        <div
          ...
          style={{
            ...
            zIndex: 1,
            animation: `pulse ${particle.duration}s ease-in-out ${
              particle.delay
            }s infinite alternate, float ${
              particle.duration * 2
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-20 z-10 max-w-6xl mx-auto">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4 mb-8">
              <a
                href="#projects"
                className="group relative bg-gradient-to-r from-blue-500 to-cyan-400 text-white py-3 px-6 rounded-lg font-medium transition-all duration-300 hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] hover:-translate-y-1 overflow-hidden inline-block"
              >
              ...
              <a
                href="#contact"
                className="group relative border border-blue-500/50 text-blue-400 py-3 px-6 rounded-lg font-medium transition-all duration-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] hover:-translate-y-1 hover:bg-blue-500/10 overflow-hidden inline-block"
              >
