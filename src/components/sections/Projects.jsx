          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="relative overflow-hidden group p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <h3 className="text-xl font-bold mb-2">
                Crystal Beauty Clare Web App
              </h3>
              <p className="text-gray-400 mb-4">
                A full-stack web application designed for Crystal Beauty Clare —
                a modern beauty service platform. It offers an intuitive
                interface for customers to explore services, buy products and
                manage profiles.
              </p>
            ...
            <div className="relative overflow-hidden group p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                A HTML/CSS-based movie search application that lets users find
                movies, view details, and explore trending films.
              </p>
            ...
            <div className="relative overflow-hidden group p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <h3 className="text-xl font-bold mb-2">
                University project - Environment pollution
              </h3>
              <p className="text-gray-400 mb-4">
                A Simple HTML, CSS, and JavaScript website project focused on
                raising awareness about environmental pollution and promoting
              ...
              <div className="flex flex-wrap gap-6 my-4">
                <a
                  href="https://github.com/sandun440/Environment_pollution.git"
                  className="text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-1 w-full sm:w-auto justify-center sm:justify-start"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  href="https://sandun440.github.io/Environment_pollution/"
                  className="relative text-blue-400 hover:text-blue-300 transition-colors w-full sm:w-auto text-center inline-block after:content-[''] after:absolute after:w-0 after:h-[2px] after:left-0 after:bottom-0 after:bg-blue-400 hover:after:w-full after:transition-all after:duration-300"
                  target="_blank"
                  rel="noopener noreferrer"
                >
